...
<body>
    ...
    <section class="reviews">
        <div class="container">
            ...
            <!-- Bootstrap=>Components=>Carousel+ свои классы(reviews__slider,reviews__item,reviews__item-name,reviews__item-text)-->
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <div class="reviews__slider">
                            ...
                            <div class="reviews__item">
                                <p class="reviews__item-name">Ирина, 38 лет</p>
                                <p class="reviews__item-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                                    Quod
                                    similique iste corporis nisi enim, accusamus veniam cumque illum dicta autem
                                    delectus ad
