        ...
        <div class="container">
            <div class="registr__inner">
                <div class="registr__content">
                    <h3 class="registr__title">Поздравляем! Вы успешно прошли опрос!!!</h3><br>
                    <a class="application-btn" href="main.php">Вернуться на главную <i class="fas fa-reply-all"></i></a>
                </div>
            </div>
        </div>
    </section>
