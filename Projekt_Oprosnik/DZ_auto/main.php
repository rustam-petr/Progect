            ...
            <div class="registr__inner">
                <div class="registr__content">
                    <form class="registr__form" action="main1.php" method="post">
                        <h3 class="registr__title">ЗАРЕГИСТРИРУЙСЯ И ПРОЙДИ ОПРОС</h3><br>
                        <input class="registr__input" type="text" name="Name" placeholder="Email" tabindex="1" autofocus>
                        <input class="registr__input" type="password" name="Password" placeholder="Password" tabindex="2">
                        <button class="registr__btn" type="submit" tabindex="3">Регистрация</button>
                    </form>
                        ...
                        <div class="reviews__slider">
                            ...
                            <div class="reviews__item" id="three">
                                ...
                                <p class="reviews__item-text">Выбирал компанию по принципу минимизировать возможные
                                    ...
                                    без каких-либо придирок и с полным возвратом ранее оставленного небольшого депозита
                                </p>
                            </div>
